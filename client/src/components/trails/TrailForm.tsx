...
export const TrailForm: React.FC<TrailFormProps> = ({
    ...
    const [trailImage, setTrailImage] = useState<File | null>(null);
    const [trailImagePreview, setTrailImagePreview] = useState<string | null>(null);
    ...
    const handleImageChange = (file: File | null, previewUrl: string | null) => {
        setTrailImage(file);
        setTrailImagePreview(previewUrl);
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // and get back a URL to store with the trail data
